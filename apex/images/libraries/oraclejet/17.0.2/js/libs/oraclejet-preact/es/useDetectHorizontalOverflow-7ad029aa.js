...
function useDetectHorizontalOverflow(options) {
    ...
    const [visibleItemKeys, setVisibleItemKeys] = useState(keysArray);
    const [overflowItemKeys, setOverflowingItemKeys] = useState();
    useEffect(() => {
        let resizeObserver;
...
export { useDetectHorizontalOverflow as u };
//# sourceMappingURL=useDetectHorizontalOverflow-7ad029aa.js.map
