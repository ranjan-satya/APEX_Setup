...
const Icon = ({ size: size$1 = '1em', color = 'currentColor', accessibleLabel = '', viewBox = 'none', children }) => (jsxRuntime.jsx(Svg, { height: "1em", width: "1em", viewBox: viewBox, accessibleLabel: accessibleLabel, class: UNSAFE_Icon_themes_IconStyle_css.styles[color], style: { fontSize: size$1 === '1em' ? size$1 : `${size.sizeToCSS(size$1)}` }, children: children }));
...
exports.Icon = Icon;
//# sourceMappingURL=Icon-3ffd13dc.js.map
