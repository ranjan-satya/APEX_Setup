...
const overlay = {
    ...
    dangerActive: rgba(colorSchemeVars.palette.danger['60'], 0.4),
    scrim: rgba(colorSchemeVars.palette.neutral['200'], 0.4),
...
const border = {
    ...
    warning: rgb(colorSchemeVars.palette.warning['110']),
    danger: rgb(colorSchemeVars.palette.danger['110']),
