...
const CheckboxItem = ({ children, value, assistiveText, helpSourceLink, helpSourceText }) => {
    ...
    const onChangeHandler = hooks.useCallback((e) => {
    ...
    return (jsxRuntime.jsx(CheckboxControl.CheckboxControl, { name: name, value: value, ...(!isReadonly && !isDisabled
            ? { onChange: onChangeHandler, onKeyUp: onChangeHandler }
            : {}), assistiveText: assistiveText, helpSourceLink: helpSourceLink, helpSourceText: helpSourceText, isChecked: isChecked, isDisabled: isDisabled, isReadonly: isReadonly, children: children }));
};

exports.CheckboxItem = CheckboxItem;
//# sourceMappingURL=UNSAFE_CheckboxItem.js.map
