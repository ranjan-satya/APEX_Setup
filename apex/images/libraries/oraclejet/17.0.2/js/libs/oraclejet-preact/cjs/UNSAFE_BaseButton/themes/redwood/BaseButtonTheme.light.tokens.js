...
const colorSchemeLight = {
    variants: {
        ...
        callToAction: {
            base: {
                backgroundColor: utils.rgb(Common_themes_themeContract_css.colorSchemeVars.palette.neutral[170]),
        ...
        danger: {
            base: {
                ...
                borderColor: 'transparent',
                color: Common_themes_themeContract_css.colorSchemeVars.textIcon.onColor
            },
            disabled: {
                backgroundColor: Common_themes_themeContract_css.colorSchemeVars.surface.disabled,
                borderColor: 'transparent',
...
exports.colorSchemeLight = colorSchemeLight;
//# sourceMappingURL=BaseButtonTheme.light.tokens.js.map
