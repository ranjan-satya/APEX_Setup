 ...
 */
export declare function FitMeterCircle({ max, min, value, step, size, startAngle, angleExtent, isTrackRendered, thresholdDisplay, indicatorSize, testId, ...props }: MeterProps): import("preact").JSX.Element;
