...
const getDaysInMonth = (month, year) => {
    if (month === '*') {
        ...
        return getFormatParse.getDaysInMonth(year, month - 1);
    }
};
/**
...
const getCalendarDateFromIso = (str) => {
    if (!getFormatParse.isDateOnlyIsoString(str)) {
        return undefined;
    }
...
exports.MAX_ISO_YEAR = MAX_ISO_YEAR;
exports.MIN_ISO_DAY = MIN_ISO_DAY;
exports.MIN_ISO_MONTH = MIN_ISO_MONTH;
exports.MIN_ISO_YEAR = MIN_ISO_YEAR;
exports.addToCalendarDate = addToCalendarDate;
exports.addToMonth = addToMonth;
exports.addToYear = addToYear;
exports.checkIsValidIsoYear = checkIsValidIsoYear;
exports.checkNoCalendarExtension = checkNoCalendarExtension;
exports.compareDates = compareDates;
exports.constrainCalendarDate = constrainCalendarDate;
exports.formatCalendarDateAsString = formatCalendarDateAsString;
exports.formatCalendarMonthRequiredAsExample = formatCalendarMonthRequiredAsExample;
exports.formatFullCalendarDate = formatFullCalendarDate;
exports.formatIsoDateStrAsExample = formatIsoDateStrAsExample;
exports.formatShortCalendarDate = formatShortCalendarDate;
exports.getCalendarDateFromIso = getCalendarDateFromIso;
exports.getCalendarDateToday = getCalendarDateToday;
exports.getClosestDecade = getClosestDecade;
exports.getDatePlaceholderMasks = getDatePlaceholderMasks;
exports.getDatePlaceholdersFromPattern = getDatePlaceholdersFromPattern;
exports.getDaysInMonth = getDaysInMonth;
exports.getFormattedYearMonthDay = getFormattedYearMonthDay;
exports.getIsoDateStr = getIsoDateStr;
exports.getLongFormattedYearMonth = getLongFormattedYearMonth;
exports.getMonthYearPlaceholdersFromDatePlaceholders = getMonthYearPlaceholdersFromDatePlaceholders;
exports.getMonthsInYear = getMonthsInYear;
exports.getNumericFormattedYear = getNumericFormattedYear;
exports.isCalendarDateAfter = isCalendarDateAfter;
exports.isCalendarDateBefore = isCalendarDateBefore;
exports.isCompleteCalendarDate = isCompleteCalendarDate;
exports.isCompleteCalendarMonth = isCompleteCalendarMonth;
exports.isDateOutOfRange = isDateOutOfRange;
exports.isValidCalendarMonthRequired = isValidCalendarMonthRequired;
exports.toIsoCalendarDate = toIsoCalendarDate;
exports.toJSDate = toJSDate;
//# sourceMappingURL=calendarDateUtils-ca9bde6d.js.map
