...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'A123400434353011690')
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(120179427425942889)
,p_name=>'USERNAME'
,p_message_language=>'it'
,p_message_text=>'Nome utente'
,p_version_scn=>2557358
);
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(120179526034942889)
,p_name=>'USERNAME_DB'
,p_message_language=>'it'
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(120179647374942889)
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(120179357307942889)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(17445722481733542.4554)
,p_branch_action=>'f?p=&APP_ID.:20:&SESSION.::&DEBUG.:::'
,p_branch_point=>'BEFORE_HEADER'
,p_branch_type=>'REDIRECT_URL'
