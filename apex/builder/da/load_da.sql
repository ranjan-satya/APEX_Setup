...
Rem
Rem    DESCRIPTION
Rem      Install Danish version of Oracle APEX Runtime Messages
Rem
Rem    REQUIREMENTS
...
prompt . ORACLE
prompt .
prompt . Oracle APEX Danish Runtime Messages Installation.
prompt ...........................................................
...
prompt Install Oracle APEX applications
begin
    ...
    for c1 in ( select flow_image_prefix, owner
        ...
        update wwv_flows
          ...
          where id in ( select translation_flow_id
                         ...
                         where translation_flow_language_code = 'da'
