...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'A123400375497011322')
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(120179089634942875)
,p_name=>'USERNAME'
,p_message_language=>'fr'
,p_message_text=>'Nom utilisateur'
,p_version_scn=>2557354
);
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(120179160398942875)
,p_name=>'USERNAME_DB'
,p_message_language=>'fr'
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(120179230969942875)
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(120178915629942875)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(17445722481733542.4552)
,p_branch_action=>'f?p=&APP_ID.:20:&SESSION.::&DEBUG.:::'
,p_branch_point=>'BEFORE_HEADER'
,p_branch_type=>'REDIRECT_URL'
