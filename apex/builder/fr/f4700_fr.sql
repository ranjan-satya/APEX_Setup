...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'A122802220953990573')
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(119661709806936892)
,p_name=>'APEX.PAGE_ITEM_IS_REQUIRED'
,p_message_language=>'fr'
,p_message_text=>'#LABEL# est requis.'
,p_version_scn=>2557093
);
end;
/
