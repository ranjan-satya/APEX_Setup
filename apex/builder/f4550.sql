...
prompt APPLICATION 4550 - Oracle APEX Workspace / INTERNAL Login
--
-- Application Export:
--   Application:     4550
...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'WORKSPACE-SIGN-IN')
...
,p_documentation_banner=>'Oracle APEX developer login and password management application.'
,p_authentication_id=>wwv_flow_imp.id(540118315091694248)
,p_populate_roles=>'A'
...
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(8560508234436339)
,p_name=>'More Information'
,p_list_status=>'PUBLIC'
,p_version_scn=>75557508
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(8561519934534279)
...
,p_list_text_01=>'Get free community-driven support for your Oracle APEX questions on the OTN discussion forums. '
,p_list_text_03=>'target="_blank"'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(8565818427600114)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(8561901018538328)
,p_list_item_display_sequence=>50
,p_list_item_link_text=>'Oracle APEX Shortcuts'
,p_list_item_link_target=>'https://apex.oracle.com/shortcuts'
,p_list_item_icon_attributes=>'alt=""'
,p_list_text_01=>'A collection of short, memorable URLs, that you can use to quickly navigate to commonly used APEX resources.'
,p_list_text_03=>'target="_blank"'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(8566004359605487)
,p_name=>'Getting Started'
,p_list_status=>'PUBLIC'
,p_version_scn=>75557508
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(8567403776605488)
,p_list_item_display_sequence=>20
,p_list_item_link_text=>'Learn More'
,p_list_item_link_target=>'https://apex.oracle.com/learnmore'
,p_list_text_01=>'A page for those just getting started or wanting to learn more about Oracle APEX.'
,p_list_text_03=>'rel="noopener noreferrer"'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(8567723889605492)
,p_list_item_display_sequence=>30
,p_list_item_link_text=>'apex.oracle.com'
,p_list_item_link_target=>'https://apex.oracle.com'
,p_list_item_icon_attributes=>'alt=""'
,p_list_text_01=>'A free, hosted service where you can try out the latest version of Oracle APEX.'
,p_list_text_03=>'rel="noopener noreferrer"'
,p_translate_list_text_y_n=>'Y'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(8568019160605492)
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(115315832368341144)
,p_name=>'Tasks'
,p_list_status=>'PUBLIC'
,p_version_scn=>75557508
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(155871030948668683)
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(22951230716918778)
,p_list_item_display_sequence=>20
...
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(6096909608250810)
,p_list_item_display_sequence=>30
...
,p_list_item_disp_condition2=>'PLSQL'
,p_list_text_01=>'Sign in to Administration Services.'
,p_translate_list_text_y_n=>'Y'
,p_security_scheme=>'!'||wwv_flow_imp.id(6153929631135099)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_imp_shared.create_list_item(
 p_id=>wwv_flow_imp.id(11365419809816264)
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(787389949330441085)
...
begin
wwv_flow_imp_shared.create_list(
 p_id=>wwv_flow_imp.id(788072921346081694)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(904950677464426)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(1278956154450573)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(1284667310777249)
,p_plugin_type=>'DYNAMIC ACTION'
,p_plugin=>'NATIVE_OPEN_AI_ASSISTANT'
,p_version_scn=>16259055
);
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(1308659493186468)
,p_plugin_type=>'WEB SOURCE TYPE'
,p_plugin=>'NATIVE_BOSS'
,p_version_scn=>243439152
);
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(3198333543136453)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(14859123746941041)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(99844960795888905)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(118481343090833028)
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(123214141121478467)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(124389883386989299)
,p_plugin_type=>'WEB SOURCE TYPE'
,p_plugin=>'NATIVE_ADFBC'
,p_version_scn=>37165931336889
);
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(176129140563506820)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(1765072874220712055)
,p_plugin_type=>'REGION TYPE'
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(1831780317545994155)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_setting(
 p_id=>wwv_flow_imp.id(1917654134230939994)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(6153929631135099)
...
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(387608696699373799)
,p_name=>'COMPANY'
,p_scope=>'GLOBAL'
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(47291523209584096)
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(16763020509404219)
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(510231751281890)
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(1788752932141210549)
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(6109409795714510)
...
begin
wwv_flow_imp_shared.create_flow_item(
 p_id=>wwv_flow_imp.id(5714319922471249)
,p_name=>'PRODUCT_TYPE'
...
wwv_flow_imp_shared.create_flow_computation(
 p_id=>wwv_flow_imp.id(387608942992380280)
...
begin
wwv_flow_imp_shared.create_flow_computation(
 p_id=>wwv_flow_imp.id(16766113976430755)
,p_computation_sequence=>10
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(20203615154961597)
...
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(20203830364961608)
,p_lov_disp_sequence=>10
,p_lov_disp_value=>'Unlock the HR sample user account'
,p_lov_return_value=>'HR'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(20204016953961621)
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(91126801753691270)
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(176634981412406067)
...
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(176635264449406069)
,p_lov_disp_sequence=>1
...
begin
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(20420213496266810)
,p_lov_name=>'ROLES'
...
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(20420400631266813)
,p_lov_disp_sequence=>10
,p_lov_disp_value=>'Database Development (RESOURCE)'
,p_lov_return_value=>'RESOURCE'
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(20420610391266814)
,p_lov_disp_sequence=>20
...
wwv_flow_imp_page.create_page_group(
 p_id=>wwv_flow_imp.id(222575208632450607)
,p_group_name=>'Login'
,p_group_desc=>'Login page, accept username and password from user.'
);
wwv_flow_imp_page.create_page_group(
 p_id=>wwv_flow_imp.id(222579123308464377)
,p_group_name=>'Logout'
,p_group_desc=>'Confirm logout event.'
);
wwv_flow_imp_page.create_page_group(
 p_id=>wwv_flow_imp.id(222577907724459883)
...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(781636565276262406)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4067279651618676)
,p_page_template_id=>wwv_flow_imp.id(781636565276262406)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4067731833618677)
,p_page_template_id=>wwv_flow_imp.id(781636565276262406)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4068232621618677)
,p_page_template_id=>wwv_flow_imp.id(781636565276262406)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4068730226618677)
,p_page_template_id=>wwv_flow_imp.id(781636565276262406)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(4069204973618677)
,p_page_template_id=>wwv_flow_imp.id(781636565276262406)
...
begin
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(787783544361971642)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140035631980349510)
,p_page_template_id=>wwv_flow_imp.id(787783544361971642)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140035749708349510)
,p_page_template_id=>wwv_flow_imp.id(787783544361971642)
,p_name=>'Page Position 1'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140035873933349510)
,p_page_template_id=>wwv_flow_imp.id(787783544361971642)
,p_name=>'Page Position 3'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140035946892349510)
,p_page_template_id=>wwv_flow_imp.id(787783544361971642)
,p_name=>'Page Position 7'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140036091738349510)
,p_page_template_id=>wwv_flow_imp.id(787783544361971642)
,p_name=>'Page Position 8'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(788153963797526843)
,p_theme_id=>3
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1514771211875371)
,p_page_template_id=>wwv_flow_imp.id(788153963797526843)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1515285207875372)
,p_page_template_id=>wwv_flow_imp.id(788153963797526843)
,p_name=>'Page Position 1'
,p_placeholder=>'REGION_POSITION_01'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1515772780875372)
,p_page_template_id=>wwv_flow_imp.id(788153963797526843)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1516299556875372)
,p_page_template_id=>wwv_flow_imp.id(788153963797526843)
,p_name=>'Page Position 3'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1516741080875372)
,p_page_template_id=>wwv_flow_imp.id(788153963797526843)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1517237038875372)
,p_page_template_id=>wwv_flow_imp.id(788153963797526843)
,p_name=>'Page Position 7'
,p_placeholder=>'REGION_POSITION_07'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1517794074875373)
,p_page_template_id=>wwv_flow_imp.id(788153963797526843)
,p_name=>'Page Position 8'
,p_placeholder=>'REGION_POSITION_08'
,p_has_grid_support=>true
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1518213018875373)
,p_page_template_id=>wwv_flow_imp.id(788153963797526843)
,p_name=>'Control Bar'
...
wwv_flow_imp_shared.create_button_templates(
 p_id=>wwv_flow_imp.id(20301506730451152)
...
begin
wwv_flow_imp_shared.create_button_templates(
 p_id=>wwv_flow_imp.id(300732121515523410)
...
begin
wwv_flow_imp_shared.create_button_templates(
 p_id=>wwv_flow_imp.id(629209698915957087)
...
begin
wwv_flow_imp_shared.create_button_templates(
 p_id=>wwv_flow_imp.id(781649650278313424)
...
begin
wwv_flow_imp_shared.create_button_templates(
 p_id=>wwv_flow_imp.id(781653829819356486)
...
begin
wwv_flow_imp_shared.create_button_templates(
 p_id=>wwv_flow_imp.id(781654005571356486)
...
begin
wwv_flow_imp_shared.create_button_templates(
 p_id=>wwv_flow_imp.id(781654809938356489)
...
begin
wwv_flow_imp_shared.create_button_templates(
 p_id=>wwv_flow_imp.id(781655181102356490)
...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(5717529496540150)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2172150847470763)
,p_plug_template_id=>wwv_flow_imp.id(5717529496540150)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2172630852470763)
,p_plug_template_id=>wwv_flow_imp.id(5717529496540150)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2173123325470763)
,p_plug_template_id=>wwv_flow_imp.id(5717529496540150)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2173680411470763)
,p_plug_template_id=>wwv_flow_imp.id(5717529496540150)
,p_name=>'Create2'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2174031857470763)
,p_plug_template_id=>wwv_flow_imp.id(5717529496540150)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2174575466470763)
,p_plug_template_id=>wwv_flow_imp.id(5717529496540150)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2175083419470764)
,p_plug_template_id=>wwv_flow_imp.id(5717529496540150)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2175537420470764)
,p_plug_template_id=>wwv_flow_imp.id(5717529496540150)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(2176073507470764)
,p_plug_template_id=>wwv_flow_imp.id(5717529496540150)
,p_name=>'Sub Regions'
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(355286322831861132)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140528869799344485)
,p_plug_template_id=>wwv_flow_imp.id(355286322831861132)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(140528984905344484)
,p_plug_template_id=>wwv_flow_imp.id(355286322831861132)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(781646415851311877)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1729010960431753)
,p_plug_template_id=>wwv_flow_imp.id(781646415851311877)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_has_region_support=>true
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1729572738431753)
,p_plug_template_id=>wwv_flow_imp.id(781646415851311877)
,p_name=>'Create'
,p_placeholder=>'CREATE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1730035090431753)
,p_plug_template_id=>wwv_flow_imp.id(781646415851311877)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1730592292431753)
,p_plug_template_id=>wwv_flow_imp.id(781646415851311877)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1731002738431754)
,p_plug_template_id=>wwv_flow_imp.id(781646415851311877)
,p_name=>'Sub Regions'
,p_placeholder=>'SUB_REGIONS'
,p_has_grid_support=>true
...
begin
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(

,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(308155882020529817)
,p_plugin_id=>wwv_flow_imp.id(356684625134447706)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>7
,p_display_sequence=>70
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(356751824591447757)
,p_plugin_type=>'AUTHENTICATION TYPE'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(356752109391447757)
,p_plugin_id=>wwv_flow_imp.id(356751824591447757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>1
,p_display_sequence=>10
,p_prompt=>'Host'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(356752525978447757)
,p_plugin_id=>wwv_flow_imp.id(356751824591447757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(356752909762447757)
,p_plugin_id=>wwv_flow_imp.id(356751824591447757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>3
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(356753326801447757)
,p_plugin_attribute_id=>wwv_flow_imp.id(356752909762447757)
,p_display_sequence=>10
,p_display_value=>'SSL'
,p_return_value=>'SSL'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(356753802092447757)
,p_plugin_attribute_id=>wwv_flow_imp.id(356752909762447757)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(356754317185447758)
,p_plugin_attribute_id=>wwv_flow_imp.id(356752909762447757)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(356754811521447759)
,p_plugin_id=>wwv_flow_imp.id(356751824591447757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>4
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(356755216699447759)
,p_plugin_id=>wwv_flow_imp.id(356751824591447757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>5
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(356755624517447759)
,p_plugin_id=>wwv_flow_imp.id(356751824591447757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>6
,p_display_sequence=>60
...
,p_display_length=>40
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(356755216699447759)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(356756013940447759)
,p_plugin_id=>wwv_flow_imp.id(356751824591447757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>7
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(356756416287447760)
,p_plugin_id=>wwv_flow_imp.id(356751824591447757)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>8
,p_display_sequence=>80
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(356756825663447760)
,p_plugin_attribute_id=>wwv_flow_imp.id(356756416287447760)
,p_display_sequence=>10
,p_display_value=>'Standard'
,p_return_value=>'STD'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(356757310563447761)
,p_plugin_attribute_id=>wwv_flow_imp.id(356756416287447760)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(356757815197447761)
,p_plugin_attribute_id=>wwv_flow_imp.id(356756416287447760)
,p_display_sequence=>30
...
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(356819703353447808)
,p_plugin_type=>'AUTHENTICATION TYPE'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(787803699949238365)
,p_plug_name=>'Header'
,p_region_css_classes=>'a-Header a-Header--login'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(781705991385407800)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(878526882713395746)
...
,p_required_patch=>wwv_flow_imp.id(182282109124837150)
);
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(878526953365395747)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(878526882713395746)
,p_button_name=>'ACKNOWLEDGE'
,p_button_static_id=>'usg_button'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#:a-Button--large'
,p_button_template_id=>wwv_flow_imp.id(781653829819356486)
,p_button_is_hot=>'Y'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(878527063282395748)
,p_name=>'Close USG Ack Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(878526953365395747)
,p_bind_type=>'bind'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(878527178035395749)
,p_event_id=>wwv_flow_imp.id(878527063282395748)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_CLOSE_REGION'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(878526882713395746)
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(878527289716395750)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(182275284387854301)
,p_event_id=>wwv_flow_imp.id(878527289716395750)
,p_event_result=>'TRUE'
,p_action_sequence=>10
...
''))
,p_step_template=>wwv_flow_imp.id(781636565276262406)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(5734329754154454)
,p_plug_name=>'Tasks'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#:a-MediaList--noIcons'
,p_plug_template=>wwv_flow_imp.id(781720832587518133)
,p_plug_display_sequence=>60
,p_plug_new_grid_row=>false
,p_plug_display_point=>'REGION_POSITION_03'
,p_plug_item_display_point=>'BELOW'
,p_list_id=>wwv_flow_imp.id(115315832368341144)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_imp.id(781726379075536728)
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(28278406447321936)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(28357414269339279)
...
,p_plug_display_point=>'REGION_POSITION_03'
,p_plug_item_display_point=>'BELOW'
,p_list_id=>wwv_flow_imp.id(8560508234436339)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_imp.id(781726379075536728)
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(28359019857369284)
...
,p_plug_display_point=>'REGION_POSITION_03'
,p_plug_item_display_point=>'BELOW'
,p_list_id=>wwv_flow_imp.id(8566004359605487)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_imp.id(781726379075536728)
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(30251320176465048)
,p_plug_name=>'&PRODUCT_NAME.'
,p_region_template_options=>'#DEFAULT#:a-Form--labelsAbove'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(781646415851311877)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(201971822038420445)
,p_plug_name=>'Languages'
,p_parent_plug_id=>wwv_flow_imp.id(30251320176465048)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(59842604093647546)
...
,p_plug_display_point=>'REGION_POSITION_03'
,p_plug_item_display_point=>'BELOW'
,p_list_id=>wwv_flow_imp.id(787389949330441085)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_imp.id(781726379075536728)
,p_plug_query_row_template=>wwv_flow_imp.id(232064200547094797)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(327446700231264735)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(698802056584413313)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(30251320176465048)
,p_button_name=>'REQUEST_WORKSPACE'
,p_button_static_id=>'req_workspace'
,p_button_action=>'REDIRECT_APP'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_imp.id(781649650278313424)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(275885678018243453)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(206357695649953049)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(698801968369413312)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(47399509230712591)
...
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_imp.id(300732121515523410)
,p_button_is_hot=>'Y'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(232005500580944564)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(9141131880673724)
,p_branch_action=>'f?p=&APP_ID.:11:&SESSION.::&DEBUG.:::'
,p_branch_point=>'BEFORE_HEADER'
,p_branch_type=>'REDIRECT_URL'
,p_branch_sequence=>10
,p_required_patch=>wwv_flow_imp.id(9152708051846605)
);
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(17417718747637820)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(9960412406494902)
,p_name=>'P1_USERNAME_LABEL'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(30251320176465048)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(30250621039456935)
...
,p_field_template=>wwv_flow_imp.id(781639159048309153)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(30251012844458645)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(30251520608467092)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(95189738956614247)
...
,p_field_template=>wwv_flow_imp.id(176608736253329086)
,p_item_template_options=>'#DEFAULT#'
,p_help_text=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<p>',
'If you select this checkbox, &PRODUCT_NAME. will save your workspace and username in a persistent browser cookie named <code>ORA_WWV_REMEMBER_UN</code>. When you go to the sign in page the next time, the workspace and username fields will be automati'
||'cally populated with these values.',
'</p>',
'<p>',
'If you deselect this checkbox and your workspace and username are already saved in the cookie, &PRODUCT_NAME. will overwrite it with an empty value. You can also use your browser''s developer tools to completely remove the cookie at any time.',
'</p>'))
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(232291604030150875)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(279105542919806103)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1778434620188603210)
,p_name=>'P1_NEXT_APP'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_imp.id(30251320176465048)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1778434823687603211)
,p_name=>'P1_NEXT_PAGE'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_imp.id(30251320176465048)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1778435028760603211)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1778435208234603211)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(5714811395478232)
,p_computation_sequence=>10
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(14794408194619070)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(698802474866413317)
,p_event_id=>wwv_flow_imp.id(698802352859413316)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(698802512740413318)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(698802638841413319)
,p_event_id=>wwv_flow_imp.id(698802512740413318)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_FOCUS'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(698802182978413314)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(698802286696413315)
,p_event_id=>wwv_flow_imp.id(698802182978413314)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_FOCUS'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(359371008265397285)
...
,p_internal_uid=>359371008265397285
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(491225097024458)
...
,p_attribute_04=>'1'
,p_internal_uid=>491225097024458
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(28292524174506792)
...
,p_process_clob_language=>'PLSQL'
,p_internal_uid=>28292524174506792
);
end;
/
...
,p_warn_on_unsaved_changes=>'N'
,p_autocomplete_on_off=>'ON'
,p_step_template=>wwv_flow_imp.id(788153963797526843)
,p_page_template_options=>'#DEFAULT#'
,p_page_component_map=>'11'
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(134636703889796037)
...
,p_first_item=>'AUTO_FIRST_ITEM'
,p_autocomplete_on_off=>'ON'
,p_step_template=>wwv_flow_imp.id(787783544361971642)
,p_page_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(22878608880410975)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(26487014153670357)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(22878608880410975)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(22883630052445491)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(22878608880410975)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(26487310047670358)
,p_branch_action=>'f?p=&APP_ID.:1:&SESSION.::&DEBUG.:4::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(26487014153670357)
,p_branch_sequence=>10
,p_save_state_before_branch_yn=>'Y'
);
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(22891903920551475)
,p_branch_action=>'f?p=&APP_ID.:1:&SESSION.::&DEBUG.:::'
,p_branch_point=>'BEFORE_COMPUTATION'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(22883630052445491)
,p_branch_sequence=>10
);
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(17445301703727502)
,p_branch_action=>'f?p=&APP_ID.:20:&SESSION.::&DEBUG.:::'
,p_branch_point=>'BEFORE_HEADER'
,p_branch_type=>'REDIRECT_URL'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(22881822648433869)
,p_name=>'F4550_P4_EMAIL'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(22878608880410975)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(5717205948533393)
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(22955710724969695)
...
,p_when_button_pressed=>wwv_flow_imp.id(26487014153670357)
,p_associated_item=>wwv_flow_imp.id(22881822648433869)
,p_error_display_location=>'INLINE_WITH_FIELD'
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(22891011754544211)
...
,p_process_when_button_id=>wwv_flow_imp.id(26487014153670357)
...
,p_internal_uid=>22891011754544211
);
end;
/
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8570511463645379)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(47285769528327391)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(47286811980358498)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(47285769528327391)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(14635328375431475)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(47285769528327391)
,p_button_name=>'Cancel'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(60120000609053928)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(60096028904579631)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(17445722481733542)
,p_branch_action=>'f?p=&APP_ID.:20:&SESSION.::&DEBUG.:::'
,p_branch_point=>'BEFORE_HEADER'
,p_branch_type=>'REDIRECT_URL'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(22923025971699756)
,p_name=>'F4550_P7_ERROR_TEXT'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(47285769528327391)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(47286220449334625)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(47286414702337991)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(232259213858994463)
,p_name=>'P7_FIND_MY_WORKSPACE_LABEL'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(8570511463645379)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(22910528694672171)
,p_computation_sequence=>10
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(47291128490577452)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_when_button_id=>wwv_flow_imp.id(47286811980358498)
,p_process_success_message=>'Reset password request has been sent for processing.'
,p_internal_uid=>47291128490577452
);
end;
/
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(47289611174520429)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(235943023326098156)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(47289611174520429)
,p_button_name=>'LOGIN'
,p_button_action=>'REDIRECT_URL'
,p_button_template_options=>'#DEFAULT#:a-Button--large'
,p_button_template_id=>wwv_flow_imp.id(781653829819356486)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(17445927460744406)
,p_branch_action=>'f?p=&APP_ID.:20:&SESSION.::&DEBUG.:::'
,p_branch_point=>'BEFORE_HEADER'
,p_branch_type=>'REDIRECT_URL'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(47290514531564696)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(72005820105419587)
,p_name=>'P8_NEXTPAGE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(47289611174520429)
,p_item_default=>'1'
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(698805599458413348)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(698805641444413349)
,p_event_id=>wwv_flow_imp.id(698805599458413348)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_FOCUS'
,p_affected_elements_type=>'BUTTON'
,p_affected_button_id=>wwv_flow_imp.id(235943023326098156)
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(48179495483070440)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_clob_language=>'PLSQL'
,p_internal_uid=>48179495483070440
);
end;
/
...
wwv_flow_imp_page.create_page(
 p_id=>10
,p_name=>'Administration Services - Sign In'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1043922209309491)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(694607830412810101)
,p_plug_name=>'Language Selector'
,p_parent_plug_id=>wwv_flow_imp.id(1043922209309491)
,p_region_css_classes=>'a-Login-links a-Login-links--languages'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(781705991385407800)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(23205800319914944)
,p_plug_name=>'init'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1334523559929118455)
,p_plug_name=>'Announcements'
,p_region_css_classes=>'a-Login-message'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(206357726853953050)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1043922209309491)
,p_button_name=>'WORKSPACE_LOGIN'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_imp.id(781649650278313424)
,p_button_image_alt=>'Workspace Sign-In'
,p_button_position=>'EDIT'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(275884985213232933)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(1043922209309491)
,p_button_name=>'GET_STARTED'
,p_button_action=>'REDIRECT_URL'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(232279713795102725)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(1043922209309491)
,p_button_name=>'LOGIN'
,p_button_action=>'SUBMIT'
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(17446617202750916)
,p_branch_action=>'f?p=&APP_ID.:20:&SESSION.::&DEBUG.:::'
,p_branch_point=>'BEFORE_HEADER'
,p_branch_type=>'REDIRECT_URL'
,p_branch_sequence=>10
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1046305318309559)
,p_name=>'P10_USERNAME'
,p_is_required=>true
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_imp.id(1043922209309491)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1046904764309561)
,p_name=>'P10_PASSWORD'
,p_is_required=>true
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(1043922209309491)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(9960755203494905)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(22928644002012305)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(279105468975806102)
...
wwv_flow_imp_page.create_page_computation(
 p_id=>wwv_flow_imp.id(5714704123476099)
,p_computation_sequence=>10
,p_computation_item=>'PRODUCT_TYPE'
,p_computation_point=>'BEFORE_HEADER'
,p_computation_type=>'FUNCTION_BODY'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(359608213674439626)
,p_process_sequence=>20
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'Login'
...
,p_process_clob_language=>'PLSQL'
,p_internal_uid=>359608213674439626
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1048720322309594)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
...
,p_attribute_01=>'CLEAR_CACHE_FOR_PAGES'
,p_attribute_04=>'10'
,p_internal_uid=>1048720322309594
);
end;
/
...
wwv_flow_imp_page.create_page(
 p_id=>20
,p_name=>'Select a Workspace'
,p_alias=>'SELECT-WORKSPACE'
,p_step_title=>'&PRODUCT_NAME. - Select a Workspace'
,p_reload_on_submit=>'A'
,p_warn_on_unsaved_changes=>'N'
,p_autocomplete_on_off=>'ON'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(355244609672857359)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(356825125052947229)
,p_plug_name=>'Announcements'
,p_region_css_classes=>'a-Login-message'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(788148989693515940)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(788149141438516546)
,p_plug_name=>'Getting Started'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#:a-MediaList--noIcons'
,p_plug_template=>wwv_flow_imp.id(781720832587518133)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(788149365141517128)
,p_plug_name=>'More Information'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#:a-MediaList--noIcons'
,p_plug_template=>wwv_flow_imp.id(781720832587518133)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(788149510285517814)
,p_plug_name=>'Social Networking Links'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(788149776764518791)
,p_plug_name=>'Tasks'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#:a-MediaList--noIcons'
,p_plug_template=>wwv_flow_imp.id(781720832587518133)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1903077399430433037)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(788098255248103123)
,p_plug_name=>'&PRODUCT_NAME.'
,p_parent_plug_id=>wwv_flow_imp.id(1903077399430433037)
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(781646415851311877)
,p_plug_display_sequence=>20
,p_plug_display_point=>'SUB_REGIONS'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(784426701644840009)
,p_plug_name=>'Additional Information Required'
,p_parent_plug_id=>wwv_flow_imp.id(788098255248103123)
,p_region_css_classes=>'a-Login-message'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_imp.id(781705991385407800)
...
'return FALSE;'))
,p_plug_display_when_cond2=>'PLSQL'
,p_required_patch=>wwv_flow_imp.id(836093046470445605)
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'expand_shortcuts', 'N',
  'output_as', 'HTML')).to_clob
);
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(788095677913088930)
,p_plug_name=>'List of Workspaces'
,p_parent_plug_id=>wwv_flow_imp.id(788098255248103123)
,p_component_template_options=>'a-MediaList--slim'
,p_plug_display_sequence=>50
,p_list_id=>wwv_flow_imp.id(788072921346081694)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_imp.id(781726379075536728)
,p_translate_title=>'N'
,p_plug_display_condition_type=>'EXISTS'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(825234084074277602)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1959512182339704219)
,p_plug_name=>'Languages'
,p_parent_plug_id=>wwv_flow_imp.id(788098255248103123)
,p_region_css_classes=>'a-Login-links a-Login-links--languages'
,p_region_template_options=>'#DEFAULT#'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(2024382717374138701)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(355343217768869136)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(788098255248103123)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(787948171855029003)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(788098255248103123)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(20780723786489096)
,p_name=>'P20_WORKSPACE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(355244609672857359)
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'N')).to_clob
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(23554931773705253)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(5499919566405279)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_when2=>'SQL'
,p_internal_uid=>5499919566405279
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(17346400590121618)
,p_process_sequence=>20
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
...
,p_internal_uid=>17346400590121618
);
end;
/
...
wwv_flow_imp_shared.create_install(
 p_id=>wwv_flow_imp.id(6152921076915006)
);
end;
/
