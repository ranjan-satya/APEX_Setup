...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'A123400966313013558')
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(120181440551942946)
,p_name=>'USERNAME'
,p_message_language=>'zh-tw'
,p_message_text=>unistr('\4F7F\7528\8005\540D\7A31')
,p_version_scn=>2557371
);
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(120181555402942946)
,p_name=>'USERNAME_DB'
,p_message_language=>'zh-tw'
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(120181615552942946)
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(120181331144942946)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(17445722481733542.4557)
,p_branch_action=>'f?p=&APP_ID.:20:&SESSION.::&DEBUG.:::'
,p_branch_point=>'BEFORE_HEADER'
,p_branch_type=>'REDIRECT_URL'
