...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'A123400815555013174')
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(120181064913942932)
,p_name=>'USERNAME'
,p_message_language=>'zh-cn'
,p_message_text=>unistr('\7528\6237\540D')
,p_version_scn=>2557369
);
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(120181166304942932)
,p_name=>'USERNAME_DB'
,p_message_language=>'zh-cn'
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(120181256494942932)
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(120180925674942932)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(17445722481733542.4556)
,p_branch_action=>'f?p=&APP_ID.:20:&SESSION.::&DEBUG.:::'
,p_branch_point=>'BEFORE_HEADER'
,p_branch_type=>'REDIRECT_URL'
