...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'A123400770618012791')
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(120180655023942922)
,p_name=>'USERNAME'
,p_message_language=>'pt-br'
,p_message_text=>unistr('Nome do Usu\00E1rio')
,p_version_scn=>2557366
);
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(120180743035942922)
,p_name=>'USERNAME_DB'
,p_message_language=>'pt-br'
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(120180804979942922)
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(120180529390942922)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(17445722481733542.4555)
,p_branch_action=>'f?p=&APP_ID.:20:&SESSION.::&DEBUG.:::'
,p_branch_point=>'BEFORE_HEADER'
,p_branch_type=>'REDIRECT_URL'
