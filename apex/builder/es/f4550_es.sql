...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'A123400251619010950')
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(120178631281942863)
,p_name=>'USERNAME'
,p_message_language=>'es'
,p_message_text=>'Usuario'
,p_version_scn=>2557352
);
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(120178708234942863)
,p_name=>'USERNAME_DB'
,p_message_language=>'es'
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(120178816943942863)
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(120178560833942863)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(17445722481733542.4551)
,p_branch_action=>'f?p=&APP_ID.:20:&SESSION.::&DEBUG.:::'
,p_branch_point=>'BEFORE_HEADER'
,p_branch_type=>'REDIRECT_URL'
