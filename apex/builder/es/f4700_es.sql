...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'A122802112553990187')
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(119661643991936857)
,p_name=>'APEX.PAGE_ITEM_IS_REQUIRED'
,p_message_language=>'es'
,p_message_text=>'#LABEL# es necesario.'
,p_version_scn=>2557090
);
end;
/
