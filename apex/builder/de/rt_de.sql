...
Rem
Rem    DESCRIPTION
Rem      Install German version of Oracle APEX runtime
Rem
Rem    NOTES
...
Rem      hfarrell   02/13/2012 - Added set define statement after f4155_de.sql (due to bug 13403278 fix)
    ...
    for c1 in (select flow_image_prefix, owner
        ...
        update wwv_flows
         ...
         where id in ( select translation_flow_id
                        ...
                        where translation_flow_language_code = 'de'
