...
,p_alias=>nvl(wwv_flow_application_install.get_application_alias,'A123400145820010585')
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(120178201718942853)
,p_name=>'USERNAME'
,p_message_language=>'de'
,p_message_text=>'Benutzername'
,p_version_scn=>2557349
);
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(120178326158942853)
,p_name=>'USERNAME_DB'
,p_message_language=>'de'
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(120178425171942853)
...
wwv_flow_imp_shared.create_message(
 p_id=>wwv_flow_imp.id(120178157780942853)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(17445722481733542.4553)
,p_branch_action=>'f?p=&APP_ID.:20:&SESSION.::&DEBUG.:::'
,p_branch_point=>'BEFORE_HEADER'
,p_branch_type=>'REDIRECT_URL'
