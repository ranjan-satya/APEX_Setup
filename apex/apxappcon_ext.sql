...
Rem    Example:
Rem
Rem      sqlplus "sys/syspass as sysdba" @apxappcon_ext SYSAUX SYSAUX TEMP /i/ Passw0rd!
Rem
Rem
...
define INSTALL_TYPE      = 'APPCONTAINEREXT'
define PHASES            = '1,2,3'
...
select 'apxappcon_ext'||to_char(sysdate,'YYYY-MM-DD_HH24-MI-SS')||'.log' foo3 from sys.dual;
