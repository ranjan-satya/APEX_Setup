...
Rem
Rem    REQUIREMENTS
Rem      - Oracle Database 19.5.0.0 or later
Rem
Rem
Rem    Arguments:
...
Rem     Position 6: The full path to this script on the filesystem
Rem
Rem    Example:
Rem
Rem    1)Local
Rem      sqlplus "sys/syspass as sysdba" @apexins_adb_ext SYSAUX SYSAUX TEMP /i/ 1,2,3 /u01/oracle/apex/
Rem
Rem    2)With connect string
Rem      sqlplus "sys/syspass@10g as sysdba" @apexins_adb_ext SYSAUX SYSAUX TEMP /i/ 1,2,3 /u01/oracle/apex/
Rem
Rem    MODIFIED   (MM/DD/YYYY)
Rem      jstraub   09/20/2024 - Created
...
@^PREFIX.core/scripts/timing_start "Complete Installation"
