...
Rem
Rem    1)Local
Rem      sqlplus "sys/syspass as sysdba" @apxrtins1 SYSAUX SYSAUX TEMP /i/
Rem
Rem    2)With connect string
Rem      sqlplus "sys/syspass@10g as sysdba" @apxrtins1 SYSAUX SYSAUX TEMP /i/
Rem
...
@@apxrtins_nocdb.sql ^DATTS ^FF_TBLS "^TEMPTBL" ^IMGPR 1
